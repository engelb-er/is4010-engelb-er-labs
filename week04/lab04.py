def find_common_elements(list1, list2):
    ...
    """
    # Use sets for efficient membership testing and intersection.
    # Order does not matter, and duplicates are not required.
...
def find_user_by_name(users, name):
    ...
    """
    # Build a dictionary index mapping name -> user profile
...
def get_list_of_even_numbers(numbers):
    ...
    """
    # Use a list comprehension to preserve order and allow duplicates.
